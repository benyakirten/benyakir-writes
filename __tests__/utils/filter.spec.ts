...
describe('filter util', () => {
    describe('createLookupFromChoices', () => {
        it('should exclude all items that are false', () => {
            ...
            expect(filter.createLookupFromChoices(expectation.choices)).toEqual(expectation.lookup)
        })

        it('should give known results for known choices', () => {
            const expectations: { choices: PotentialChoice[], lookup: BooleanLookup }[] = [
                {
                    choices: [
                        {
                            value: 'a',
    ...
    describe('getValuesForSelected', () => {
        it('should exclude all items that are false', () => {
            ...
            expect(filter.getValuesForSelected(expectation.choices)).toEqual(expectation.result)
        })
