...
describe('posts util', () => {
    describe('formatWpText', () => {
        it('should produce known results for known inputs', () => {
            ...
            for (let expectation of expectations) {
                expect(posts.formatWpText(expectation.input)).toEqual(expectation.result)
            }
        })
    })
    ...
    describe('rigorousTextFormat', () => {
        it('should produce known results for known inputs', () => {
            ...
            for (let expectation of expectations) {
                expect(posts.rigorousTextFormat(expectation.input)).toEqual(expectation.result)
            }
        })
    })
    ...
    describe('createSearchableString', () => {
        it('should produce known results for known inputs', () => {
            const expectations: { input: (string | number | undefined)[], result: string }[] = [
                {
            ...
            for (let expectation of expectations) {
                expect(posts.createSearchableString(expectation.input)).toEqual(expectation.result)
            }
        })
    })
    ...
    describe('createMetaForObject', () => {
        it('should produce known results for known inputs', () => {
            ...
            for (let expectation of expectations) {
                expect(posts.createMetaForObject(expectation.input)).toEqual(expectation.result)
            }
        })
    })
    ...
    describe('createLookupMeta', () => {
        it('should produce known results for known inputs', () => {
            ...
            for (let expectation of expectations) {
                expect(posts.createLookupMeta(expectation.input)).toEqual(expectation.result)
            }
        })
    })
})