...
describe("404 page", () => {
  ...
  it("should render some boilersheet info", async () => {
    ...
    expect(text.textContent).toEqual(
      "Unfortunately, the page you were looking for doesn't exist. I suggest you find a link that better suits you from the left hand side. Or you can just visit the home page by clicking here."
    );
    expect(text.firstElementChild!.textContent).toEqual(
