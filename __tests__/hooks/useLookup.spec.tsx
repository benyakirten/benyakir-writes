...
const LookupTest: React.FC = () => {
    ...
    return (
        <>
            <button title="deactivate" onClick={deactivate}>Deactivate Item</button>
            <button title="activate" onClick={activate}>Activate Item</button>
            <button title="toggle" onClick={toggle}>Toggle</button>
...
describe('useLookup hook', () => {
    ...
    beforeEach(async () => {
        render(<LookupTest />)
        deactivateButton = await screen.findByTitle('deactivate') as HTMLButtonElement
