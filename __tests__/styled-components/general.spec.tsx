...
describe('general styled components', () => {
    describe('Transition components', () => {
        describe('FadeIn', () => {
            it('should accept a duration and delay prop that determines the animations duration and delay of the component', () => {
                ...
                const testComp1 = renderer.create(<General.FadeIn delay={DELAY_1} duration={DURATION_1} />).toJSON()

                expect(testComp1).toMatchSnapshot()
                expect(testComp1).toHaveStyleRule('animation', `dMKEGd ${DURATION_1} ${DELAY_1} ease forwards`)

                const DELAY_2 = '600ms'
                const DURATION_2 = '2000ms'
                const testComp2 = renderer.create(<General.FadeIn delay={DELAY_2} duration={DURATION_2} />).toJSON()

                expect(testComp2).toMatchSnapshot()
                expect(testComp2).toHaveStyleRule('animation', `dMKEGd ${DURATION_2} ${DELAY_2} ease forwards`)
            })
            ...
            it('should have a default value for the delay and duration if none is provided', () => {
                ...
                expect(testComp).toHaveStyleRule('animation', `dMKEGd 1600ms 0ms ease forwards`)
            })
        })
        ...
        describe('SlideInLeft', () => {
            it('should accept a duration and delay prop that determines the animations duration and delay of the component', () => {
                const DELAY_1 = '300ms'
                const DURATION_1 = '1000ms'
                const testComp1 = renderer.create(<General.SlideInLeft delay={DELAY_1} duration={DURATION_1} />).toJSON()

                expect(testComp1).toMatchSnapshot()
                expect(testComp1).toHaveStyleRule('animation', `hOeomY ${DURATION_1} ${DELAY_1} ease forwards`)

                const DELAY_2 = '600ms'
                const DURATION_2 = '2000ms'
                const testComp2 = renderer.create(<General.SlideInLeft delay={DELAY_2} duration={DURATION_2} />).toJSON()

                expect(testComp2).toMatchSnapshot()
                expect(testComp2).toHaveStyleRule('animation', `hOeomY ${DURATION_2} ${DELAY_2} ease forwards`)
            })

            it('should have a default value for the delay and duration if none is provided', () => {
                const testComp = renderer.create(<General.SlideInLeft />).toJSON()
                expect(testComp).toMatchSnapshot()
                expect(testComp).toHaveStyleRule('animation', `hOeomY 4s 0ms ease forwards`)
            })
            ...
            describe('SlideInRight', () => {
                it('should accept a duration and delay prop that determines the animations duration and delay of the component', () => {
                    const DELAY_1 = '300ms'
                    const DURATION_1 = '1000ms'
                    const testComp1 = renderer.create(<General.SlideInRight delay={DELAY_1} duration={DURATION_1} />).toJSON()
    
                    expect(testComp1).toMatchSnapshot()
                    expect(testComp1).toHaveStyleRule('animation', `dcBvEg ${DURATION_1} ${DELAY_1} ease forwards`)
    
                    const DELAY_2 = '600ms'
                    const DURATION_2 = '2000ms'
                    const testComp2 = renderer.create(<General.SlideInRight delay={DELAY_2} duration={DURATION_2} />).toJSON()
    
                    expect(testComp2).toMatchSnapshot()
                    expect(testComp2).toHaveStyleRule('animation', `dcBvEg ${DURATION_2} ${DELAY_2} ease forwards`)
                })
    
                it('should have a default value for the delay and duration if none is provided', () => {
                    const testComp = renderer.create(<General.SlideInRight />).toJSON()
                    expect(testComp).toMatchSnapshot()
                    expect(testComp).toHaveStyleRule('animation', `dcBvEg 4s 0ms ease forwards`)
                })
            })
        })
    })
    ...
    describe('Text components', () => {
        ...
        describe('SubHeading', () => {
            it('should set the text-decoration property to none based on the noUnderline prop', () => {
                const comp1 = renderer.create(<General.SubHeading noUnderline />).toJSON()
                expect(comp1).toMatchSnapshot()
                expect(comp1).toHaveStyleRule('text-decoration', 'none')

                const comp2 = renderer.create(<General.SubHeading noUnderline={false} />).toJSON()
                expect(comp2).toMatchSnapshot()
                expect(comp2).toHaveStyleRule('text-decoration', 'underline')
            })
        ...
        describe('BigParagraph', () => {
            it('should set the margin-right property to the marginRight prop passed in', () => {
                const comp = renderer.create(<General.BigParagraph marginRight="12rem" />).toJSON()
                expect(comp).toMatchSnapshot()
    ...
    describe('Other components', () => {
        describe("HoverableContainer", () => {
            it('should set the height and width peropties based on the props passed in', () => {
                const comp = renderer.create(<General.HoverableContainer height={400} width={800} />).toJSON()
                expect(comp).toMatchSnapshot()
