...
describe("Search component", () => {
    ...
    it("should create cards with links and text for every item that corresponds to the search data", async () => {
        render(<Search {...props} />);
        const text = (await screen.getByRole("textbox")) as HTMLInputElement;
        const resultsContainer = (await screen.getByText("No results yet!")).parentElement!
        ...
        await act(async () => {
            ...
            expect(results[0].firstElementChild!.getAttribute('href')).toEqual(getSlug(searchData[0]))
            expect(results[0].firstElementChild!.firstElementChild!.children[0].textContent).toEqual(searchData[0].title)
            expect(results[0].firstElementChild!.firstElementChild!.children[1].textContent).toEqual(capitalize(searchData[0].type))

            expect(results[1].firstElementChild!.getAttribute('href')).toEqual(getSlug(searchData[2]))
            expect(results[1].firstElementChild!.firstElementChild!.children[0].textContent).toEqual(searchData[2].title)
            expect(results[1].firstElementChild!.firstElementChild!.children[1].textContent).toEqual(capitalize(searchData[2].type))

            expect(results[2].firstElementChild!.getAttribute('href')).toEqual(getSlug(searchData[4]))
            expect(results[2].firstElementChild!.firstElementChild!.children[0].textContent).toEqual(searchData[4].title)
            expect(results[2].firstElementChild!.firstElementChild!.children[1].textContent).toEqual(capitalize(searchData[4].type))

            expect(results[3].firstElementChild!.getAttribute('href')).toEqual(getSlug(searchData[6]))
            expect(results[3].firstElementChild!.firstElementChild!.children[0].textContent).toEqual(searchData[6].title)
            expect(results[3].firstElementChild!.firstElementChild!.children[1].textContent).toEqual(capitalize(searchData[6].type))
        })
        ...
        await act(async () => {
            ...
            expect(results[0].firstElementChild!.getAttribute('href')).toEqual(getSlug(searchData[1]))
            expect(results[0].firstElementChild!.firstElementChild!.children[0].textContent).toEqual(searchData[1].title)
            expect(results[0].firstElementChild!.firstElementChild!.children[1].textContent).toEqual(capitalize(searchData[1].type))

            expect(results[1].firstElementChild!.getAttribute('href')).toEqual(getSlug(searchData[3]))
            expect(results[1].firstElementChild!.firstElementChild!.children[0].textContent).toEqual(searchData[3].title)
            expect(results[1].firstElementChild!.firstElementChild!.children[1].textContent).toEqual(capitalize(searchData[3].type))
        })
    });
