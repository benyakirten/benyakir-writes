...
describe("Search component", () => {
	...
	it("should create cards with links and text for every item that corresponds to the search data", async () => {
		...
		await act(async () => {
			...
			expect(
				results[0].firstElementChild!.firstElementChild!.children[0]
					.textContent,
			).toEqual(searchData[0].title);
			expect(
				results[0].firstElementChild!.firstElementChild!.children[1]
					.textContent,
			...
			expect(
				results[1].firstElementChild!.firstElementChild!.children[0]
					.textContent,
			).toEqual(searchData[2].title);
			expect(
				results[1].firstElementChild!.firstElementChild!.children[1]
					.textContent,
			...
			expect(
				results[2].firstElementChild!.firstElementChild!.children[0]
					.textContent,
			).toEqual(searchData[4].title);
			expect(
				results[2].firstElementChild!.firstElementChild!.children[1]
					.textContent,
			...
			expect(
				results[3].firstElementChild!.firstElementChild!.children[0]
					.textContent,
			).toEqual(searchData[6].title);
			expect(
				results[3].firstElementChild!.firstElementChild!.children[1]
					.textContent,
