...
describe('Foldout component', () => {
  ...
  it('should render properly', () => {
    expect(() =>
      render(<Foldout onClick={clickSpy} topbar={<p>Hello</p>} />)
    ).not.toThrow()
  })

  it("should set the down arrow's tabindex according to the open prop", async () => {
    render(
      <Foldout onClick={clickSpy} topbar={<p>Test Topbar</p>} open={false} />
    )
    ...
    render(
      <Foldout onClick={clickSpy} topbar={<p>Test Topbar</p>} open={true} />
    )
