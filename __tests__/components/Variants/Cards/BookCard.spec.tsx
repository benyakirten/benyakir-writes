...
import type { FlattenedBook } from "@Types/posts";
...
describe("BookCard component", () => {
	...
	it("should render a div with the content, limited to 200 or 600 words if there is a book cover or related stories", async () => {
		...
		expect(contentOne.textContent).toEqual("Test book content A");
		...
		expect(contentTwo.textContent).toEqual("Test book content B");
	});
	...
	describe("cover or stories", () => {
		...
		it("should render an image of the book cover if it exists", async () => {
			...
			const link =
				cover.parentElement?.parentElement?.parentElement?.parentElement!;
