  ...
  const testProjects = [
    {
      ...
      meta: createLookupMeta(
        "python py sep september 2019 project content a projectaslug project title a"
      ),
    },
    {
      ...
      meta: createLookupMeta(
        "repo github angular graphql ng gql oct october 2019 google project content b projectbslug project title b"
      ),
    },
  ].sort(
