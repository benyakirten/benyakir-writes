...
describe('AllFilter component', () => {
  const testPosts = [
    ...
    },
    {
      ...
      meta: createLookupMeta(
        '2019 sep 9 september blogpostaslug blog post a tag abc'
      ),
    },
    {
      title: 'blog post E',
      ...
      tags: ['tag abc'],
      meta: createLookupMeta(
        '2020 8 august blog-post-e blog post e cat abcd tag abc'
      ),
    },
    {
      title: 'blog post B',
      ...
      tags: null,
      meta: createLookupMeta(
        '2020 sep 9 september blog-post-b blog post b cat abcd'
      ),
    },
    {
      title: 'blog post F',
    ...
    },
    {
      ...
      tags: null,
      meta: createLookupMeta(
        '2021 sep 9 september blog-post-c blog post c cat abcd'
      ),
    },
  ].sort(
    (a, b) => b.published.date.getTime() - a.published.date.getTime()
  ) as FlattenedBlogCard[]
  ...
  it('should render correctly', () => {
    expect(() => render(<AllFilter {...props} />)).not.toThrow()
  })

  it('should render a text element and three foldouts that contain means of filtering the elements', async () => {
  ...
  it('should filter the elements based on their meta values if the text input has its value changed', async () => {
    ...
    await act(async () => {
      ...
      // On call 2, it's called with an array - we want that array because it's what the function is called with
