...
const ContactPage: React.FC = () => {
    ...
    return (
        <>
            ...
            <Paragraph>
                This is still a work in progress. If it doesn't work, I urge you to either send me an email directly
                at <CustomLink outside to="mailto:ben@benyakiredits.com">ben@benyakiredits.com</CustomLink> or send
                me a message through the&nbsp;
                <CustomLink outside to="https://benyakiredits.com/about-me/contact">contact screen on my old blog</CustomLink>.
            </Paragraph>
            <Form
                name="Contact Form"
                method="POST"
